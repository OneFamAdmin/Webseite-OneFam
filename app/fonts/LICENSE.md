OneFam self-hosts the following fonts under the Fontshare / Indian Type Foundry Free Font License (FFL).

- Cabinet Grotesk (Variable) — Indian Type Foundry
- Satoshi (Variable + Variable Italic) — Indian Type Foundry

Free for personal & commercial use, including web embedding/self-hosting. The font files may not be sold or redistributed on their own. Full license text below.
